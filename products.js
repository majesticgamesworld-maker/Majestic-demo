...
const CATEGORIES = [
  { id: "board-games", label: "Board Games", icon: "🎲", color: "cat-board", bg: "images/background images/Board games.png" },
  { id: "card-games", label: "Card Games", icon: "🃏", color: "cat-card" },
  { id: "family-games", label: "Family Games", icon: "👨‍👩‍👧‍👦", color: "cat-family" },
  { id: "kids-games", label: "Kids Games", icon: "🧸", color: "cat-kids" },
  { id: "puzzles", label: "Puzzles", icon: "🧩", color: "cat-puzzles" },
  { id: "trivia-games", label: "Trivia Games", icon: "❓", color: "cat-trivia" },
  { id: "christian-games", label: "Christian Games", icon: "✝️", color: "cat-christian" },
  { id: "stem-toys", label: "STEM Toys", icon: "🔬", color: "cat-stem" },
  { id: "lego-collectible", label: "LEGO / Collectible", icon: "🧱", color: "cat-lego" },
  { id: "infant-toys", label: "Infant Toys", icon: "👶", color: "cat-infant" },
  { id: "musical-toys", label: "Musical Toys", icon: "🎵", color: "cat-musical" },
  { id: "dolls", label: "Dolls", icon: "🎎", color: "cat-dolls" },
  { id: "couples-games", label: "Couples Games", icon: "❤️", color: "cat-couples" },
  { id: "party-games", label: "Party Games", icon: "🎉", color: "cat-party" },
  { id: "drinking-games", label: "Drinking Games", icon: "🍺", color: "cat-drinking" },
];
